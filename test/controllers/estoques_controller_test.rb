...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference("Estoque.count") do
      post estoques_url, params: { estoque: { competencia: @estoque.competencia, qtde_entrada: @estoque.qtde_entrada, qtde_estoque: @estoque.qtde_estoque, qtde_saida: @estoque.qtde_saida } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { competencia: @estoque.competencia, qtde_entrada: @estoque.qtde_entrada, qtde_estoque: @estoque.qtde_estoque, qtde_saida: @estoque.qtde_saida } }
