class FornecedoresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fornecedor.save
        format.html { redirect_to fornecedores_path, notice: "Fornecedor #{@fornecedor.nome} cadastrado com sucesso!" }
  ...
  def update
    respond_to do |format|
      if @fornecedor.update(fornecedor_params)
        format.html { redirect_to fornecedores_path, notice: "Fornecedor #{@fornecedor.nome} atualizado com sucesso!" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to fornecedores_url, notice: "Fornecedor #{@fornecedor.nome} removido com sucesso!" }
